...
const items = [
  ...
  { text: 'Main Menu and Start Screen', completed: true },
  { text: 'Implement random enemy Spawn System', completed: true },
  { text: 'Constraint player play area', completed: true },
  { text: 'Player Audio feedback', completed: true },
  { text: 'Enemy Audio feedback', completed: true },
  { text: 'Prepare Web Player build', completed: false },
